...
$.payment.cards = cards = [
  ...
  # Adding some BR patterns
  # Source: https://github.com/erikhenrique/bin-cc
  {
    type: 'aura'
    patterns: [50]
    format: defaultFormat
  ...
  }
  {
    ...
    #You gotta hate elo
    patterns: [
      4011, 401178, 401179, 431274,
      438935, 451416, 457393, 4576,
      457631, 457632, 506699, /^5067[0-6]/
      /^50677[0-8]/, 509, 627780, 636297,
      636368, 636369, /^65003[1-3|5-9]/,
      65004, /^65005[0-1]/, /^65040[5-9]/,
      /^6504[1-3]/, /^65048[5-9]/, 65049,
      /^6505[0-2]/, /^65053[0-8]/, /^65054[1-9]/,
      /^6505[5-8]/, /^65059[0-8]/, 65070, /^65071[0-8]/,
      /^65072[0-7]/, /^65090[1-9]/, 65091, 650920,
      /^65165[2-9]/, /^6516[6-7]/, /^6550[0-1]/,
      /^65502[1-9]/, /^6550[3-4]/, /^65505[0-8]/
    ]
    format: defaultFormat
    length: [16]
    cvcLength: [3]
