...
(function() {
  ...
  restrictCardNumber = function(e) {
    var $target, card, digit, value, _ref;
    $target = $(e.currentTarget);
    digit = String.fromCharCode(e.which);
    if (!/^\d+$/.test(digit)) {
      return;
    ...
    if (card) {
      return _ref = value.length, __indexOf.call(card.length, _ref) >= 0;
    } else {
  ...
  setCardType = function(e) {
    var $target, allTypes, card, cardType, val, _i, _len;
    $target = $(e.currentTarget);
    val = $target.val();
  ...
  $.validateCardNumber = function(num) {
    ...
    return (_ref = num.length, __indexOf.call(card.length, _ref) >= 0) && luhnCheck(num);
  };
